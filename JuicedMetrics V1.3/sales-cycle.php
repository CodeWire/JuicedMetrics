...
<script src="<?php echo plugins_url("assets/javascripts/foo/footable.filter.js?v=2-0-1", __FILE__);?>" type="text/javascript"></script>
...
$fbcount=0;
...

	{
		...
		if(trim($stats->website) != '')
			...
			//echo $pageviews_per_visitor;echo '<br />';
