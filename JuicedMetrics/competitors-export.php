...
--><!--<link rel="stylesheet" type="text/css" href="<?php echo plugins_url("assets/css/dataTables.bootstrap.css", __FILE__);?>">

-->

    <link href="<?php echo plugins_url("assets/css/foo/footable.core.css?v=2-0-1", __FILE__);?>" rel="stylesheet" type="text/css"/>

<link href="<?php echo plugins_url("assets/css/foo/footable.standalone.css", __FILE__);?>" rel="stylesheet" type="text/css"/>

<link href="<?php echo plugins_url("assets/css/foo/footable-demos.css", __FILE__);?>" rel="stylesheet" type="text/css"/>
...
<script type="text/javascript" src="<?php echo plugins_url("assets/javascripts/jquery-1.10.2.min.js", __FILE__);?>"></script>



<script src="<?php echo plugins_url("assets/javascripts/foo/footable.js?v=2-0-1", __FILE__);?>" type="text/javascript"></script>



<script src="<?php echo plugins_url("assets/javascripts/foo/footable.sort.js?v=2-0-1", __FILE__);?>" type="text/javascript"></script>

<script src="<?php echo plugins_url("assets/javascripts/foo/footable.paginate.js?v=2-0-1", __FILE__);?>" type="text/javascript"></script>
...
<script type="text/javascript" src="<?php echo plugins_url("assets/javascripts/jquery.dataTables.js", __FILE__);?>"></script>
...
<!--<script type="text/javascript" src="<?php //echo plugins_url("assets/javascripts/dataTables.bootstrap.js", __FILE__);?>"></script>
